...
index 0000000000000000000000000000000000000000..fd4965f08fee6bbc6757ebe256c652455563abd1 100644
--- a//dev/null
...
+
+
+def _placeholder_scraper(keyword: str, location: str | None = None):
+    """Return no results; real implementation pending."""
+    return []
+
+
+EXTRA_SCRAPERS: Dict[str, Callable[[str, str | None], list]] = {
